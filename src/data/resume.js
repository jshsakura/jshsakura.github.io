      ...
      projects: [
        {
          ...
          description: 'WMS 시스템 고도화, LME 레피니티브 Python API 연동 및 선적입출고 관리 기능 개발에 참여',
          tech: ['Python', 'API', 'WMS'],
        },
        {
          name: 'NC소프트 CMS, HR 시스템 고도화',
          period: '2022.01 ~ 2024.01',
          description: 'CMS(Charge Code Management) 시스템 개발 참여, 넥사크로 기반 근태(HR) 시스템을 React로 리뉴얼하는 작업에 투입',
        ...
        {
          name: '스마일게이트 총무 시스템 개발',
          period: '2025.01 ~ 2025.11',
          description: '총무 시스템 신규 개발에 참여',
          tech: ['Java', 'Spring', 'React'],
        },
        {
          name: '서린정보기술 StayByMe ERP 고도화 및 평가시스템 개발',
          period: '2025.12 ~ 2026.01',
          description: 'AI를 활용한 적극적인 개선 적용 및 코드 리팩토링 수행',
          tech: ['Java', 'Spring'],
        },
      ],
    },
      ...
      projects: [
        {
          ...
          description: 'ASP Classic 기반 SPMS 고객관리 시스템 운영 및 Java 전환 작업에 참여. 2년차부터 SCMS 고객센터 시스템도 함께 담당',
        ...
        },
        {
          ...
          description: 'Java Spring 기반 논문 심사 기능 추가, 심사서 양식 다양화 및 비용/차수별 심사결과 수정 작업에 참여',
          tech: ['Java', 'Spring'],
        },
        {
          name: '대한건축사협회 시공자 정보 제공 서비스 개발',
          period: '2018.04 ~ 2018.08',
          description: 'Java SpringBoot 기반 건축정보 시스템 개발에 참여. 공통 프레임워크 구축부터 인프라까지 전반적으로 투입',
          tech: ['SpringBoot', 'Oracle'],
        },
        {
          name: '현대엔지니어링 HSE 안전관리포탈 고도화',
          period: '2018.08 ~ 2019.02',
          description: 'ASP.NET 기반 시스템의 UI 프레임워크(DevExpress) 버전 업 및 디자인 변경, 모바일 앱 연동 API 추가 작업에 참여',
          tech: ['ASP.NET', 'DevExpress', 'API'],
        },
        {
          name: '누리미디어 DBPIA ONE 기능개선',
          period: '2018.10 ~ 2019.02',
          description: '비회원 심사위원 관리, 증명서 발급, Remind 메일, 편집위원장 결재 기능 등 추가 개발에 참여',
          tech: ['Java', 'Spring'],
        },
        {
          name: 'LS트랙터 딜러 포탈 SSO 개발',
          period: '2019.03 ~ 2019.03',
          description: '해외 딜러 주문시스템의 SSO 통합인증 기능 개발에 참여',
          tech: ['Java', 'SSO', 'Spring'],
        },
        {
          name: '나이스디앤비 무역정보 포털 개발',
          period: '2019.04 ~ 2019.09',
          description: '웹스퀘어4 기반 UI, Java Spring + Oracle 백엔드 공통 구현 및 D&B DUNS 연동 작업에 참여',
          tech: ['Java', 'Spring', 'Oracle', 'WebSquare'],
        },
        {
          name: 'LS전선 진단포털 DPS 개발',
          period: '2019.10 ~ 2020.02',
          description: '진단포털 시스템 구축 및 카탈로그 관리용 모바일 앱 API 개발에 참여',
          tech: ['Java', 'Spring', 'API'],
        },
        {
          name: '삼천리 홈페이지 운영·유지보수',
          period: '2020.02 ~ 2020.04',
          description: '삼천리 홈페이지 운영 및 윤리경영, 이메일 제보 기능 개발에 참여',
          tech: ['Java', 'Spring'],
        },
      ],
    },
